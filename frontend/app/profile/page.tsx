...
import { formatCurrency, formatDate, getOrdersByUserId, getOrderStats, getStatusColor, getStatusLabel, type Order } from '@/lib/orders';
import { CheckCircle, Clock, Edit, Heart, LogOut, Mail, MapPin, Package, Phone, Settings, ShoppingBag, Truck, User as UserIcon } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const stats = customer ? getOrderStats(customer.id) : null;
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 mb-8">
          <div className="flex border-b border-gray-200 overflow-x-auto">
            <button
              ...
              className={`px-6 py-4 font-semibold transition-colors flex items-center gap-2 whitespace-nowrap ${activeTab === 'info'
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-colors flex items-center gap-2 whitespace-nowrap ${activeTab === 'orders'
                ? 'text-purple-600 border-b-2 border-purple-600'
                : 'text-gray-600 hover:text-gray-900'
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-colors flex items-center gap-2 whitespace-nowrap ${activeTab === 'wishlist'
                ? 'text-purple-600 border-b-2 border-purple-600'
                : 'text-gray-600 hover:text-gray-900'
                }`}
            >
            ...
            <button
              ...
              className={`px-6 py-4 font-semibold transition-colors flex items-center gap-2 whitespace-nowrap ${activeTab === 'settings'
                ? 'text-purple-600 border-b-2 border-purple-600'
                : 'text-gray-600 hover:text-gray-900'
                }`}
            >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                  ...
                  <div className="flex gap-2 overflow-x-auto pb-2">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium whitespace-nowrap transition-colors ${orderFilter === 'all'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium whitespace-nowrap transition-colors ${orderFilter === 'pending'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium whitespace-nowrap transition-colors ${orderFilter === 'shipping'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium whitespace-nowrap transition-colors ${orderFilter === 'delivered'
