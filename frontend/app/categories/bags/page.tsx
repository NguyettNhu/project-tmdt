...
import { Briefcase, Package, ShoppingBag, Wallet } from 'lucide-react';
...
export default function BagsCategoryPage() {
  // Sử dụng hook để lấy sản phẩm theo category type "bags"
  const { products: apiProducts, loading, error } = useProductsByCategoryType('bags');
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-orange-50 to-red-50">
      ...
      {/* Hero Banner */}
      <div className="bg-linear-to-r from-orange-600 to-red-500 text-white">
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-4">
              <ShoppingBag className="w-12 h-12 md:w-16 md:h-16 mr-4" />
              <h1 className="text-5xl md:text-7xl font-black">TÚI XÁCH</h1>
            </div>
            <p className="text-xl md:text-2xl font-semibold mb-6">
              Phong cách tiện lợi - Chất lượng bền bỉ
            </p>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 -mt-8">
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center transform hover:scale-105 transition-transform">
            <div className="text-orange-600 mb-2 flex justify-center"><ShoppingBag className="w-8 h-8" /></div>
            <div className="text-sm font-semibold text-gray-700">Túi xách</div>
            <div className="text-xs text-gray-500 mt-1">Thời thượng</div>
          </div>
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center transform hover:scale-105 transition-transform">
            <div className="text-orange-600 mb-2 flex justify-center"><Package className="w-8 h-8" /></div>
            <div className="text-sm font-semibold text-gray-700">Balo</div>
            <div className="text-xs text-gray-500 mt-1">Năng động</div>
          </div>
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center transform hover:scale-105 transition-transform">
            <div className="text-orange-600 mb-2 flex justify-center"><Briefcase className="w-8 h-8" /></div>
            <div className="text-sm font-semibold text-gray-700">Cặp công sở</div>
            <div className="text-xs text-gray-500 mt-1">Lịch sự</div>
          </div>
          <div className="bg-white rounded-2xl shadow-xl p-6 text-center transform hover:scale-105 transition-transform">
            <div className="text-orange-600 mb-2 flex justify-center"><Wallet className="w-8 h-8" /></div>
            <div className="text-sm font-semibold text-gray-700">Ví</div>
            <div className="text-xs text-gray-500 mt-1">Nhỏ gọn</div>
          </div>
        </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
              <div className="flex items-center mb-6">
                <FaFilter className="text-2xl text-orange-600 mr-3" />
                  ...
                  {categories.map((category) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-300 ${selectedCategory === category
                          ? 'bg-linear-to-r from-orange-600 to-red-500 text-white shadow-lg'
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white text-gray-700 font-medium"
                >
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 mb-6 flex flex-col sm:flex-row items-center justify-between">
              <div className="text-gray-700 font-medium mb-2 sm:mb-0">
                Hiển thị <span className="font-bold text-orange-600">{filteredAndSortedProducts.length}</span> sản phẩm
              </div>
            ...
            {filteredAndSortedProducts.length === 0 ? (
              <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-linear-to-r from-orange-600 to-red-500 text-white font-semibold rounded-xl hover:shadow-lg transition-all"
                >
                  Xem tất cả sản phẩm
                </button>
              </div>
                  ...
                  <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group">
                    ...
                    {product.featured && (
                      <div className="absolute top-4 right-4 z-10">
                        <div className="bg-orange-500 text-white font-bold text-xs px-3 py-1 rounded-full shadow-lg">
                          HOT
                        </div>
                      </div>
                    )}
                    ...
                    <div className="p-6">
                      ...
                      <button
                        ...
                        className="w-full bg-linear-to-r from-orange-600 to-red-500 text-white font-semibold py-3 rounded-xl hover:shadow-xl transition-all duration-300 hover:scale-105"
                      >
                        Xem chi tiết
                      </button>
                    </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-linear-to-r from-orange-600 to-red-500 rounded-2xl shadow-xl p-8 md:p-12 text-center text-white">
          <div className="mb-4 flex justify-center"><ShoppingBag className="w-16 h-16" /></div>
          <h2 className="text-4xl font-black mb-4">TÚI XÁCH CAO CẤP</h2>
          <p className="text-xl mb-6 max-w-2xl mx-auto opacity-90">
            Phong cách tiện lợi, chất lượng bền bỉ. Lựa chọn hoàn hảo cho mọi dịp.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="px-8 py-3 bg-white text-orange-600 font-semibold rounded-full hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              Khám phá ngay
            </button>
            <a
