...
import { CircleUser, Footprints, Heart, Home, Layers, Scan, Shirt, ShoppingBag, Sparkles, Square, User, Wind } from 'lucide-react';
...
export default function ShopContent() {
  ...
  const categoryStructure = [
    { name: 'All', label: 'Tất cả', IconComponent: Home },
    { name: 'T-Shirts', label: 'Áo thun', IconComponent: Shirt },
    { name: 'Hoodies', label: 'Áo hoodie', IconComponent: Layers },
    { name: 'Jackets', label: 'Áo khoác', IconComponent: Wind },
    { name: 'Blazers', label: 'Áo vest', IconComponent: User },
    { name: 'Pants', label: 'Quần dài', IconComponent: Scan },
    { name: 'Shorts', label: 'Quần short', IconComponent: Square },
    { name: 'Shoes', label: 'Giày dép', IconComponent: Footprints },
    { name: 'Hats', label: 'Mũ nón', IconComponent: CircleUser },
    { name: 'Bags', label: 'Túi xách', IconComponent: ShoppingBag },
    { name: 'Plushies', label: 'Gấu bông', IconComponent: Heart },
    { name: 'Accessories', label: 'Phụ kiện', IconComponent: Sparkles },
  ];
                  ...
                  {categoryStructure.map((category) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left px-6 py-3.5 rounded-2xl transition-all duration-300 flex items-center gap-3 font-medium ${selectedCategory === category.name
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      onClick={() => {
                        setPriceRange([5000000, 100000000]);
                        handleFilterChange();
                      }}
                      className="px-3 py-1 text-xs bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
                    >
                    ...
                    {categoryStructure.map((category) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 py-3 rounded-xl text-sm font-medium transition-all flex items-center gap-2 justify-center ${selectedCategory === category.name
