...
function floatchart() {
    ...
    $(function() {
        ...
        new ApexCharts(document.querySelector("#support-chart0"), options1).render();
    });
    // [ support-chart ] end
    ...
    $(function() {
        ...
        new ApexCharts(document.querySelector("#support-chart6"), options1).render();
    });
    $(function() {
        var options1 = {
            chart: {
        ...
        new ApexCharts(document.querySelector("#support-chart7"), options1).render();
    });
    $(function() {
        var options1 = {
            chart: {
        ...
        new ApexCharts(document.querySelector("#support-chart8"), options1).render();
    });
    // [ support-chart1 ] end
