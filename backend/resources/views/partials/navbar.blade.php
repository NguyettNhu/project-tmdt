        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="{{ auth()->user()->image 
                    ...
                    : asset('/assets/img/img-default.jpg') }}"
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    <a href="{{ route('user.view.update', ['id' => auth()->user()->id]) }}" class="btn btn-default btn-flat">
                        Hồ Sơ
                    </a>
                    <a href="{{ route('auth.ajax.logout') }}" class="btn btn-default btn-flat float-right">
                        Đăng Xuất
                    </a>
                </li>
            </ul>
