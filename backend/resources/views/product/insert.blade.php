                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <input type="number" class="form-control" name="price" id="price" placeholder="Nhập Price">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" class="form-control" name="sold" id="sold" placeholder="Nhập Sold">
                        </div>
                        <div>
