              ...
              <div className="space-y-6">
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 bg-slate-900 text-slate-400 rounded-md shadow">Or continue with</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    type="button"
                    className="flex items-center justify-center gap-3 px-6 py-4 bg-slate-800/50 border-2 border-slate-700/50 rounded-2xl hover:bg-slate-800 hover:border-slate-600 transition-all duration-200 group"
                  >
